...
//$sql        = "SELECT * FROM tb_registros INNER JOIN tb_clientes ON tb_registros.cod_register = tb_clientes.tb_cod_register";
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item">
        ...
        <a href="ClientView.php" class="nav-link active link-dark">
  ...
  <!--      <thead>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $dc->cod_cliente; ?></td>
                <td><?php echo $dc->nomeCliente; ?></td>
                <td><?php echo $dc->cpf; ?></td>
                <?php if($_SESSION['nivel'] == 2){ ?>
