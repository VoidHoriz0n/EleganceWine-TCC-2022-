...
$sql        = "SELECT * FROM tb_produtos WHERE cod_Produtos = ?";  
$arrayParam = array($id);  
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <label>Nome Produto</label>
            <input type="text" class="form-control col-lg-6" name="nomeProduto" value="<?php echo $dados->nome; ?>">
        <label>Preço</label>
...
*/
    ...
    //header("Refresh: 0; url= ProductView.php");
 }
?>
