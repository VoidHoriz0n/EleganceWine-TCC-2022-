...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
      <li>
        <a href="createProduto.php" class="nav-link active link-dark">
    ...
    <div class="container">
        <form method="POST" enctype="multipart/form-data">
            ...
            <select name='categoria' class="form-control form-select col-lg-6">
                ...
                <option value="<?php echo $dc->cod_categoria; ?>"><?php echo $dc->nome; ?></option>
                <?php }?>
            </select>
            ...
            <input type="text" class="form-control col-lg-6" name="capacidadeProduto">

            <label>Validade</label>
            <input type="text" class="form-control col-lg-6" name="validade">

            <label>Tipo da Embalagem</label>
            <input type="text" class="form-control col-lg-6" name="embalagem">

            <label>Nacionalidade</label>
            <input type="text" class="form-control col-lg-6" name="nacionalidade">

            <label>Tipo</label>
            <input type="text" class="form-control col-lg-6" name="tipo">

            <label>Classificação</label>
            <input type="text" class="form-control col-lg-6" name="classificacao">

            <label>Descrição</label>
            <input type="text" class="form-control col-lg-6" name="descricao">

            <label>Preço</label>
            <input type="text" class="form-control col-lg-6" name="preco">
            <label>Imagem</label>
            <input type="text" class="form-control col-lg-6" name="imagem">>
...
/*
 ...
 (`cod_produtos`, `nome`, `capacidade`, `validade`, `tipo_embalagem`, `tipo`, `nacionalidade`, `valor`, `categoria`, `classificacao`, `imagem`, `descricao`) 
 VALUES 
 ('1', 'Aviary Rose 2021', '750ml', '24/10/2022', 'Vidro', 'Rose', 'Chile', '29.90', NULL, 'Seco', 'https://imgur.com/vinho', 'asdadadasdawds');
*/
...
/*
  INSERT INTO `tb_produtos` (`cod_produtos`, `nome`, `capacidade`, `validade`, `tipo_embalagem`, `tipo`, `nacionalidade`, `valor`, `classificacao`, `imagem`, `descricao`) 
  VALUES ('2', 'VinhoTeste', '2L', '21/11/2022', 'Vidro', 'Vidro', 'Brasil', '12', 'Rose', 'https://imagem.com', 'Um bom vinho');
*/
    $nomeProduto  = isset($_POST['nomeProduto']) ? $_POST['nomeProduto'] : null;
    $capacidadeProduto  = isset($_POST['capacidadeProduto']) ? $_POST['capacidadeProduto'] : null;
    $validade  = isset($_POST['validade']) ? $_POST['validade'] : null;
    $embalagem  = isset($_POST['embalagem']) ? $_POST['embalagem'] : null;
    $nacionalidade  = isset($_POST['nomeProduto']) ? $_POST['nomeProduto'] : null;
