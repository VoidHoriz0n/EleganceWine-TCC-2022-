...
$sql        = "SELECT * FROM tb_promocoes WHERE cod_promocao = ?";  
$arrayParam = array($id);  
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <label>Data final</label>
            <input type="text" class="form-control col-lg-6" name="datfim" value="<?php echo $dados->data_fim; ?>">
        <label>Data de Inicio</label>
            <input type="text" class="form-control col-lg-6" name="datinicio" value="<?php echo $dados->data_inicio; ?>">
        <label>Preço</label>
            <input type="text" class="form-control col-lg-6" name="preco" value="<?php echo $dados->valor; ?>">
        <label>Produto</label>
            <input type="text" class="form-control col-lg-6" name="fkprod" value="<?php echo $dados->produtos_cod_produtos; ?>">
...
// validar os dados vindo do formulário
 if(isset($_POST['btAlterar'])){
    ...
    $datfim  = isset($_POST['datfim']) ? $_POST['datfim'] : null;
    $datinicio      = isset($_POST['datinicio']) ? $_POST['datinicio'] : null;
    $preco    = isset($_POST['preco']) ? $_POST['preco'] : null;
    $fkprod    = isset($_POST['fkprod']) ? $_POST['fkprod'] : null;
...
*/
    // Edi tar os dados da produto com id ? 
    $Produtos = array(
        'data_fim'=> $datfim,
        'data_inicio' => $datinicio, 
        'valor' => $preco,
        'produto_cod_produos' => $fkprod);
