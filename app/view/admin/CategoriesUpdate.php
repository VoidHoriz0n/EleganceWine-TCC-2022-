...
$sql        = "SELECT * FROM tb_categorias WHERE cod_categoria = ?";  
$arrayParam = array($id);  
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="CategoriesUpdate.php" class="nav-link active link-dark">
        <i class="fa-solid fa-folder-plus"></i>
          Alterar Categorias
        </a>
      </li>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        <form method="POST">
            ...
            <input type="text" class="form-control col-lg-6" name="descricao" value="<?php echo $dados->descricao; ?>">
...
// validar os dados vindo do formulário
 if(isset($_POST['btAlterar'])){
    ...
    $Categoria = array('descricao' => $descricao);  
    $arrayCond = array('cod_Categorias=' => $id);  
