...
<html lang="pt_BR">
  ...
  <symbol id="binary" viewBox="0 0 16 16">
  ...
  <symbol id="addbuton" viewBox="0 0 16 16">
    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
  </symbol>
  <symbol id="cateadd" viewBox="0 0 16 16">
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="PromotionsView.php" class="nav-link active link-dark">
        <i class="fa-sharp fa-solid fa-eye"></i>
           Visualizar Promoção
        </a>
      </li>
    ...
    <div class="row">
      ...
      <div class="container ">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $dc->cod_promocao; ?></td>
                <td><?php echo $dc->valor; ?></td>
                <td><?php echo $dc->data_inicio; ?></td>
                <td><?php echo $dc->data_fim; ?></td>
                <?php if($_SESSION['nivel'] == 2){ ?>
                <td><a class="btn btn-primary" href="PromotionUpdate.php?id=<?php echo $dc->cod_promocao;?>"><i class="fa-sharp fa-solid fa-pen"></i><!--alterar--></a></td>
                <td><a class="btn btn-danger" href="deleteCliente.php?id=<?php echo $dc->cod_promocao;?>" onclick="return confirm('Tem certeza que deseja deletar esse registro?');"><i class="fa-sharp fa-solid fa-trash"></i><!--Excluir--></a></td>
                <?php } ?>
            <tr>
            <?php }?>
            <tr>
...
<!--?php include_once "classes/fimhtml.php"; ?>c-->
