...
$crud = Crud::getInstance($pdo, 'tb_categorias');  
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="CategoriesView.php" class="nav-link active link-dark">
    ...
    <div class="row">
      ...
      <div class="container ">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $dc->cod_categoria; ?></td>
                <td><?php echo $dc->nome; ?></td>
                <?php if($_SESSION['nivel'] == 2){ ?>
                <td><a class="btn btn-primary" href="updateCliente.php?id=<?php echo $dc->cod_Cliente;?>"><i class="fa-sharp fa-solid fa-pen"></i><!--alterar--></a></td>
