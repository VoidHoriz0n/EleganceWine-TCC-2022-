...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="ProductView.php" class="nav-link active link-dark">
        <i class="fa-sharp fa-solid fa-eye"></i>
           Visualizar Produto
        </a>
      </li>
  ...
  <div class="container-fluid">
    ...
    <!----->
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $dp->cod_produtos; ?></td>
                <td><?php echo $dp->nome; ?></td>
                <td><?php echo $dp->descricao; ?></td>
             <!--   <td>?php echo $dp->descricaoUnidade; ?></td> -->
                <td><?php echo $dp->valor; ?></td>
             <!--   <td>?php echo $dp->estoque; ?></td> -->
                <?php if($_SESSION['nivel'] == 2){ ?>
                <td><a class="btn btn-primary" href="ProductUpdate.php?id=<?php echo $dp->cod_produtos;?>">Altera</a></td>
                <td><a class="btn btn-danger" href="deleteProduto.php?id=<?php echo $dp->cod_produtos;?>" onclick="return confirm('Tem certeza que deseja deletar esse registro?');">Excluir</a></td>
                <?php } ?>
            <tr>
            <?php }?>
            <tr>
