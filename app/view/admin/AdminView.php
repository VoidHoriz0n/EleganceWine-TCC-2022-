...
$sql        = "SELECT * FROM tb_registros WHERE nivel = 2 ORDER BY cod_register ASC ";
//$sql        = "SELECT * FROM tb_registros INNER JOIN tb_clientes ON tb_registros.cod_register = tb_clientes.tb_registros_cod_register";
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="AdminView.php" class="nav-link active link-dark">
        <i class="fa-sharp fa-solid fa-eye"></i>
           Visualizar Admin
        </a>
      </li>
  ...
  <!--      <thead>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $dc->cod_register; ?></td>
                <td pattern="[0-9]{3}\.?[0-9]{3}\.?[0-9]{3}\-?[0-9]{2}
                "><?php echo $dc->nome; ?></td>
                <td><?php echo $dc->email; ?></td>
                <?php if($_SESSION['nivel'] == 2){ ?>
                <td><a class="btn btn-primary" href="updateCliente.php?id=<?php echo $dc->cod_register;?>"><i class="fa-sharp fa-solid fa-pen"></i><!--alterar--></a></td>
                <td><a class="btn btn-danger" href="deleteCliente.php?id=<?php echo $dc->cod_register;?>" onclick="return confirm('Tem certeza que deseja deletar esse registro?');"><i class="fa-sharp fa-solid fa-trash"></i><!--Excluir--></a></td>
                <?php } ?>
            <tr>
            <?php }?>
            <tr>
