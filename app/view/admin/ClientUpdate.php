...
$crud = Crud::getInstance($pdo, 'tb_registros');

$id = $_GET['id'];

// Consulta os dados da categoria com id informado 
$sql        = "SELECT * FROM tb_registros WHERE cod_register = ?";  
$arrayParam = array($id);  
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <div class="dropdown">
        ...
        <!--  <img src="https://github.com/voidhoriz0n.png" alt="" width="32" height="32" class="rounded-circle me-2"> -->
        ...
        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
          <li><a class="dropdown-item" href="#"><i class="fa-solid fa-gears"></i> ❘ Configurações</a></li>
   ...
   <!---div com foto da conta--> 
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="pedidos.html" class="nav-link link-dark">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>
          Pedidos
        </a>
      </li>
      <li>
        <a href="gerenciar.php" class="nav-link link-dark">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="createCliente" class="nav-link link-dark">
      ...
      <li>
        <a href="cupom.php" class="nav-link link-dark">
      ...
      <li>
        <a href="CupomView.php" class="nav-link link-dark">
         <i class="fa-sharp fa-solid fa-eye"></i>
           Visualizar Cupom
        </a>
      </li>   
      ...
      <li class="nav-item">
        <a href="deleteCliente" class="nav-link link-dark">
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <label>Nome Cliente</label>
          <input type="text" class="form-control col-lg-6" name="nome" value="<?php echo $dados->nome; ?>">
        <label>Usuário</label>
          <input type="text" class="form-control col-lg-6" name="usuario" value="<?php echo $dados->usuario; ?>">
        <label>Email</label>
...
// validar os dados vindo do formulário
 if(isset($_POST['btAlterar'])){
    ...
    $Clientes = array(
        ...
        'usuario'    => $usuario,
        'email'             => $email);  
    $arrayCond = array('cod_register=' => $id);  
